...
<body>
    ...
    <div class="row">
        <!-- Each column in the row is a pin -->
        <div class="col-auto text-center pin">
            <!-- At the top of each pin is a container that either holds a dropdown menu or a save pin button if there are no boards (can't tell when pinterest actually makes the decision to include the boards here) -->
